...
class Chart
{
     ...
     */
    public function __construct($name, Title $title = null, Legend $legend = null, PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = 'gap', Title $xAxisLabel = null, Title $yAxisLabel = null, Axis $xAxis = null, Axis $yAxis = null, GridLines $majorGridlines = null, GridLines $minorGridlines = null, Title $secondaryXAxisLabel = null, Title $secondaryYAxisLabel = null, Axis $secondaryXAxis = null, Axis $secondaryYAxis = null)
    {
        $this->name = $name;
        $this->title = $title;
        $this->legend = $legend;
